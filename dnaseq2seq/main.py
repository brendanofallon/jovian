...
def main():
    ...
    callparser.add_argument("-m", "--model-path", help="Path to model", default=os.getenv('JENEVER_MODEL'))
    callparser.add_argument("-c", "--classifier-path", help="Stored variant classifier model", default=os.getenv('JENEVER_CLASSIFIER'), type=str)
