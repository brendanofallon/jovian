...
CONF=/uufs/chpc.utah.edu/common/home/u0379426/src/dnaseq2seq/wgs_lcbigmap_chrsE.yaml


DEST=/uufs/chpc.utah.edu/common/home/arup-storage3/u0379426/pregen_lcbigmap_d150_chrsE
...
$PYTHON $ds2s pregen -c $DEST/$CONF -d $DEST --threads 28 --batch-size $BATCH_SIZE > $DEST/stdout.log 
