...
DEST=/uufs/chpc.utah.edu/common/home/arup-storage3/u0379426/pregen_wgs_multindel_nova_nochr21or22_twomoresamples/

BATCH_SIZE=128

mkdir -p $DEST

$PYTHON $ds2s pregen -c $CONF -d $DEST --threads 4 --batch-size $BATCH_SIZE > $DEST/stdout.log 
