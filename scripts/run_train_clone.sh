...
RUN_NAME="wgs_25m_multaltfixfix_cont3"
...
$PYTHON $ds2s train \
    ...
    -i /uufs/chpc.utah.edu/common/home/arup-storage3/u0379426/variant_transformer_runs/wgs_25m_multaltfixfix_cont2/wgs_25m_multaltfixfix_cont2_epoch2.model \
