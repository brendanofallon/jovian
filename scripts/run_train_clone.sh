...
RUN_NAME="wgs_25m_multaltfixfix_cont2"
...
$PYTHON $ds2s train \
    ...
    -i /uufs/chpc.utah.edu/common/home/arup-storage3/u0379426/variant_transformer_runs/wgs_25m_multaltfixfix_cont1/wgs_25m_multaltfixfix_cont1_epoch6.model \
