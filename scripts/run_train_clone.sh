...
RUN_NAME="wgs_50m_bigger_cont"
RUN_NOTES="50M model, width 150, contination"
...
$PYTHON $ds2s train \
    ...
    -i /uufs/chpc.utah.edu/common/home/u0379426/storage/variant_transformer_runs/wgs_50m_bigger/wgs_50m_bigger_epoch2.model \
