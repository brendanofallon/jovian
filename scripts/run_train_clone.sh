...
RUN_NAME="wgs_25m_w150_bigger_cont5"
RUN_NOTES="150 width, 'bigger' training data, continued 5"
...
$PYTHON $ds2s train \
    ...
    -o ${RUN_NAME}.model \
    --threads 1 \
    -i /uufs/chpc.utah.edu/common/home/u0379426/storage/variant_transformer_runs/wgs_25m_w150_bigger_cont4/wgs_25m_w150_bigger_cont4_epoch2.model \
