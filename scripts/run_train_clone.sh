...
RUN_NAME="wgs_50m_bigger_cont3"
RUN_NOTES="50M model, width 150, contination3"
...
$PYTHON $ds2s train \
    ...
    -i /uufs/chpc.utah.edu/common/home/u0379426/storage/variant_transformer_runs/wgs_50m_bigger_cont2/wgs_50m_bigger_cont2_epoch2.model \
