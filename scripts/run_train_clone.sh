...
RUN_NAME="wgs_50m_bigger_cont4"
RUN_NOTES="50M model, width 150, contination4"
...
$PYTHON $ds2s train \
    ...
    -i /uufs/chpc.utah.edu/common/home/u0379426/storage/variant_transformer_runs/wgs_50m_bigger_cont3/wgs_50m_bigger_cont3_epoch1.model \
