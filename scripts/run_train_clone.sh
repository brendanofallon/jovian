...
RUN_NAME="wgs_25m_w150_bigger_cont2_fix"
RUN_NOTES="150 width, 'bigger' training data, continued2 - other one started from incorrect model"
...
$PYTHON $ds2s train \
    ...
    -o ${RUN_NAME}.model \
    --threads 1 \
    -i /uufs/chpc.utah.edu/common/home/u0379426/storage/variant_transformer_runs/wgs_25m_w150_bigger_cont/wgs_25m_w150_bigger_cont_epoch1.model \
