...
Accurate inference of the DNA sequence variants in a sample is a fundamental component of modern genomics analysis. Tools that aim to identify variants must overcome several challenges to produce an accurate set of variant calls. For instance, the sequenced reads themselves may contain errors in the form of miscalled bases or PCR-induced repeat length errors, or the tool used to align reads to the reference genome may produce incorrect mappings (e.g. Li et al. 2014). 
